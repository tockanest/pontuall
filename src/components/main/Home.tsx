...
export default function HomePage(
    ...
    function handleRegularDayLogic(user: IUsers, time: any, check: HourData, HorarioEntrada: string | null, MinutosTolerancia: string | null, HorarioSaida: string | null): void {
        ...
        switch (true) {
            ...
            case !checkValue(check, "lunch_break_out"): {
                ...
                if (currentTime.isBefore(MinLunchTimeDate.subtract(parseInt(MinutosTolerancia), 'minutes'))) {
                    ...
                    setDialogMessage({
                        message: `O ponto de saída do almoço deve ser batido após as ${MinLunchTimeDate.format("HH:mm:ss")}`,
                        type: "warning",
                        release: "clock_out"
                    });
                    setMessageDialogOpen(true);
            ...
            case !checkValue(check, "lunch_break_return"): {
                ...
                console.log(MaxLunchTimeDate.toString());
    ...
    function handleSkipValidation(skipValidation: {
        type: "ClockLunchOut" | "ClockLunchReturn" | "ClockOut"
    }, user: IUsers, time: any, check: any): void {
    ...
    function updateUserHourData(user: IUsers, time: any, check: any, type: "ClockLunchOut" | "ClockLunchReturn" | "ClockOut" | "ClockIn"): void {
